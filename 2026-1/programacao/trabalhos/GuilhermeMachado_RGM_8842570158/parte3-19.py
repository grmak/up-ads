...
def msge(tentativas, acertou) -> str:
    if acertou and tentativas <= 3:
        return 'Você acertou ! MESTRE !'
    elif acertou and tentativas <=5:
        return 'Você acertou ! Muito bom !'
    elif acertou and tentativas <= 7:
